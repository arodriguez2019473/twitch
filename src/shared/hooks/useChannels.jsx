...
import { getChannels as getChannelsRequest, getFollowedChannel } from "../../services/api";
...
export const useChannels = () => {
    ...
    const getChannels = async (isLogged = false) =>{
        ...
        if (channelsData.error){
            return toast.error(
                ...
                'Ocurrruo un error al buscar los canales en la base de datos'
            )
        }
    if(!isLogged){
        return setChannels({
    ...
    const followedChannelsData = await getFollowedChannel()
    ...
    setChannels({
        channels: channelsData.data.channels,
        followedChannelsData: channelsData.data.followedChannels.filter(channel =>
